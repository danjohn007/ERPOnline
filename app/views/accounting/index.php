    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body text-center py-5">
                <div class="mb-4">
                    <i class="fas fa-calculator text-success" style="font-size: 4rem; opacity: 0.7;"></i>
                </div>
                <h1 class="h3 mb-3">
                ...
                <p class="text-muted mb-4">
                    Módulo para la gestión contable, asientos, estados financieros y reportes contables.
                </p>
